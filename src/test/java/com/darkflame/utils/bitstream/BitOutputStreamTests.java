...
public class BitOutputStreamTests {
    ...
    // -- BitOutputStream.writeUTF8String(String, boolean) Tests

    /**
     * Tests whether or not we can write a valid string to the output stream.
     */
    @Test
    public void testWriteUTF8String_ValidStringNullTerminated() {

        // Create the stream
        String str = "test";

        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF8String(str, true);

        // Verify our data
        Assert.assertEquals(40, bitOutputStream.getNumBitsUsed());
        Assert.assertEquals(5, bitOutputStream.getNumBytesUsed());

        // Test our string
        Assert.assertEquals(str.charAt(0), bitOutputStream.getDataAtIndex(0));
        Assert.assertEquals(str.charAt(1), bitOutputStream.getDataAtIndex(1));
        Assert.assertEquals(str.charAt(2), bitOutputStream.getDataAtIndex(2));
        Assert.assertEquals(str.charAt(3), bitOutputStream.getDataAtIndex(3));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(4));
    }

    /**
     * Tests whether or not we can write a valid string to the output stream that is
     * not null terminated.
     */
    @Test
    public void testWriteUTF8String_ValidStringNotNullTerminated() {

        // Create the stream
        String str = "test";

        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF8String(str, false);
    ...
    /**
     * Make sure that a null string throws an illegal argument error.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testWriteUTF8String_NullString() {

        // Create the stream
        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF8String(null, true);
    }



    // -- BitOutputStream.writeUTF16String(String, boolean) Tests

    /**
     * Tests whether or not we can write a valid UTF-16 string to the output stream.
     */
    @Test
    public void testWriteUTF16String_ValidStringNullTerminated() {

        // Create the stream
        String str = "test";

        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF16String(str, true);

        // Verify the data
        Assert.assertEquals(80, bitOutputStream.getNumBitsUsed());
        Assert.assertEquals(10, bitOutputStream.getNumBytesUsed());

        // Verify the string
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(0));
        Assert.assertEquals(str.charAt(0), bitOutputStream.getDataAtIndex(1));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(2));
        Assert.assertEquals(str.charAt(1), bitOutputStream.getDataAtIndex(3));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(4));
        Assert.assertEquals(str.charAt(2), bitOutputStream.getDataAtIndex(5));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(6));
        Assert.assertEquals(str.charAt(3), bitOutputStream.getDataAtIndex(7));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(8));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(9));
    }
     ...
     */
    @Test
    public void testWriteUTF16String_ValidStringNotNullTerminated() {

        // Create the stream
        String str = "test";

        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF16String(str, false);
    ...
    /**
     * Makes sure a null string throws an error.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testWriteUTF16String_NullString() {

        // Create the stream
        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF16String(null, true);
    }



    // -- BitOutputStream.writeUTF16StringLE(String, boolean) Tests

    /**
     * Tests whether or not we can write a valid UTF-16 string in
     * little-endian to the output stream.
     */
    @Test
    public void testWriteUTF16StringLE_ValidStringNullTerminated() {

        // Create the stream
        String str = "test";

        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF16StringLE(str, true);
        ...
        Assert.assertEquals(str.charAt(1), bitOutputStream.getDataAtIndex(2));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(3));
        Assert.assertEquals(str.charAt(2), bitOutputStream.getDataAtIndex(4));
        Assert.assertEquals((byte) 0x00, bitOutputStream.getDataAtIndex(5));
        Assert.assertEquals(str.charAt(3), bitOutputStream.getDataAtIndex(6));
    ...
    /**
     * Tests whether or not we can write a valid UTF-16 string
     * in little-endian to the output stream.
     */
    @Test
    public void testWriteUTF16StringLE_ValidStringNotNullTerminated() {

        // Create the stream
        String str = "test";

        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF16StringLE(str, false);
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public void testWriteUTF16StringLE_NullString() {

        // Create the stream
        BitOutputStream bitOutputStream = new BitOutputStream();
        bitOutputStream.writeUTF16StringLE(null, true);
    }
}
